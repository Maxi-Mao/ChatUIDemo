package com.maxi.chatui.entity;

import java.io.Serializable;

/**
 * Created by Mao Jiqing on 2016/10/14.
 */
public class IMMessageBean implements Serializable {
    ...
    private boolean UserVoiceReaded;
    ...
    public boolean isUserVoiceReaded() {
        return UserVoiceReaded;
    }

    public void setUserVoiceReaded(boolean userVoiceReaded) {
        UserVoiceReaded = userVoiceReaded;
    }
